...
const QuotesSection = () => {
    ...
    return (
        <>
            <section id="quotes_sec" className="flex flex-col py-16">
                <div className="flex flex-col justify-center items-center">
                    <div className="flex flex-row border px-4 py-8  w-fit h-[50px] items-center  border-primaryWhite">
                        <p className="text-primaryWhite md:text-left text-center italic">
                        &quot;If you quit when you suck, you will suck forever.&quot;
                        </p>                    
                    </div>
                </div>
                <div className="flex flex-col items-center lg:pl-[346px]">
